...
describe('ElementTypes', () => {
  ...
  describe('constructor', () => {
    ...
    it('should have expected element types in definitions', () => {
      const expectedTypes = ['link', 'navigation', 'heading', 'button', 'checkbox', 'radio', 'dropdown', 'textbox', 'file', 'list', 'listitem', 'menu', 'menuitem', 'toolbar', 'dialog', 'table', 'row', 'column', 'image', 'element'];

...
const ACTION_MAP = {
  ...
  isSelected: (a) => `Checking if '${a.data}' in `,
  isVisible: () => 'Checking if ',
  isDisabled: () => 'Checking if ',
  isNotDisabled: () => 'Checking if ',
  waitVisibility: () => 'Waiting for ',
  waitInvisibility: () => 'Waiting for ',
  check: () => 'Checking ',
  uncheck: () => 'Unchecking ',
  isChecked: () => 'Checking if the ',
  isUnchecked: () => 'Checking if the ',
  on: () => 'Setting ',
  off: () => 'Setting ',
  isOn: () => 'Checking if the ',
  isOff: () => 'Checking if the ',

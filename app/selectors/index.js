class Selectors {
  ...
  getSelectors(attribute, exact = false) {
    ...
    return {
      ...
      radio: `//*[(${str}) and (@role='radio' or @type='radio')]`,
      ...
      dropdown: `//*[(${str})]/ancestor-or-self::*[@dropdownbutton]`,
      option: `//*[(${str})]/ancestor-or-self::*[@role='option' or self::option]`,
      image: `//*[(${str}) and self::img]`,
      dialog: `//*[(${str})]/ancestor-or-self::*[@role='dialog']`,
  ...
  get selectors() {
    return {
      ...
      radio: `//*[@role='radio' or @type='radio']`,
      ...
      option: `//*[@role='option' or self::option]`,
      image: `//*[self::img]`,
      dialog: `//*[@role='dialog']`,
